...
const (
	...
	Query_ListVirtualFrontierContracts_FullMethodName       = "/ethermint.evm.v1.Query/ListVirtualFrontierContracts"
	Query_VirtualFrontierContractByAddress_FullMethodName   = "/ethermint.evm.v1.Query/VirtualFrontierContractByAddress"
	Query_VirtualFrontierBankContractByDenom_FullMethodName = "/ethermint.evm.v1.Query/VirtualFrontierBankContractByDenom"
	Query_ListVirtualFrontierBankContracts_FullMethodName   = "/ethermint.evm.v1.Query/ListVirtualFrontierBankContracts"
)
...
func (c *queryClient) ListVirtualFrontierContracts(ctx context.Context, in *QueryVirtualFrontierContractsRequest, opts ...grpc.CallOption) (*QueryVirtualFrontierContractsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_ListVirtualFrontierContracts_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) VirtualFrontierContractByAddress(ctx context.Context, in *QueryVirtualFrontierContractByAddressRequest, opts ...grpc.CallOption) (*QueryVirtualFrontierContractByAddressResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_VirtualFrontierContractByAddress_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) VirtualFrontierBankContractByDenom(ctx context.Context, in *QueryVirtualFrontierBankContractByDenomRequest, opts ...grpc.CallOption) (*QueryVirtualFrontierBankContractByDenomResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_VirtualFrontierBankContractByDenom_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ListVirtualFrontierBankContracts(ctx context.Context, in *QueryVirtualFrontierBankContractsRequest, opts ...grpc.CallOption) (*QueryVirtualFrontierBankContractsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_ListVirtualFrontierBankContracts_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedQueryServer) ListVirtualFrontierContracts(context.Context, *QueryVirtualFrontierContractsRequest) (*QueryVirtualFrontierContractsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListVirtualFrontierContracts not implemented")
}
func (UnimplementedQueryServer) VirtualFrontierContractByAddress(context.Context, *QueryVirtualFrontierContractByAddressRequest) (*QueryVirtualFrontierContractByAddressResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method VirtualFrontierContractByAddress not implemented")
}
func (UnimplementedQueryServer) VirtualFrontierBankContractByDenom(context.Context, *QueryVirtualFrontierBankContractByDenomRequest) (*QueryVirtualFrontierBankContractByDenomResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method VirtualFrontierBankContractByDenom not implemented")
}
func (UnimplementedQueryServer) ListVirtualFrontierBankContracts(context.Context, *QueryVirtualFrontierBankContractsRequest) (*QueryVirtualFrontierBankContractsResponse, error) {
...
func _Query_ListVirtualFrontierContracts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_ListVirtualFrontierContracts_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_VirtualFrontierContractByAddress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_VirtualFrontierContractByAddress_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_VirtualFrontierBankContractByDenom_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_VirtualFrontierBankContractByDenom_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_ListVirtualFrontierBankContracts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_ListVirtualFrontierBankContracts_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {

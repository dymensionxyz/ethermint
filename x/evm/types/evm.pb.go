...
type Params struct {
	...
	// virtual_frontier_contracts defines the list of address of registered Virtual Frontier Contracts.
	// It is not prohibited to update this via gov.
	VirtualFrontierContracts []string `protobuf:"bytes,7,rep,name=virtual_frontier_contracts,json=virtualFrontierContracts,proto3" json:"virtual_frontier_contracts,omitempty"`
}
...
func (m *Params) GetVirtualFrontierContracts() []string {
	if m != nil {
		return m.VirtualFrontierContracts
	}
	return nil
}
...
var fileDescriptor_d21ecc92c8c8583e = []byte{
	...
	,
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.VirtualFrontierContracts) > 0 {
		for iNdEx := len(m.VirtualFrontierContracts) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.VirtualFrontierContracts[iNdEx])
			copy(dAtA[i:], m.VirtualFrontierContracts[iNdEx])
			i = encodeVarintEvm(dAtA, i, uint64(len(m.VirtualFrontierContracts[iNdEx])))
			i--
			dAtA[i] = 0x3a
		}
	}
...
func (m *Params) Size() (n int) {
	...
	if len(m.VirtualFrontierContracts) > 0 {
		for _, s := range m.VirtualFrontierContracts {
			l = len(s)
			n += 1 + l + sovEvm(uint64(l))
		}
	}
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field VirtualFrontierContracts", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.VirtualFrontierContracts = append(m.VirtualFrontierContracts, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex

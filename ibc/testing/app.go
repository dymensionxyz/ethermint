...
import (
	...
	evmosapp "github.com/evmos/ethermint/app"
...
func SetupWithGenesisValSet(t *testing.T, valSet *tmtypes.ValidatorSet, genAccs []authtypes.GenesisAccount, chainID string, balances ...banktypes.Balance) ibcgotesting.TestingApp {
	...
	stakingParams.BondDenom = testtypes.BaseDenom
	...
	for _, b := range balances {
		...
		totalSupply = totalSupply.Add(b.Coins.Add(sdk.NewCoin(testtypes.BaseDenom, bondAmt))...)
	}

	// add bonded amount to bonded pool module account
	balances = append(balances, banktypes.Balance{
		Address: authtypes.NewModuleAddress(stakingtypes.BondedPoolName).String(),
		Coins:   sdk.Coins{sdk.NewCoin(testtypes.BaseDenom, bondAmt)},
	})

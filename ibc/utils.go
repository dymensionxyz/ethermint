...
func GetTransferSenderRecipientFromData(data transfertypes.FungibleTokenPacketData) (sender, recipient sdk.AccAddress, err error) {
	...
	sender, err = GetEthermintAddressFromBech32(data.Sender)
	if err != nil {
	...
	recipient, err = GetEthermintAddressFromBech32(data.Receiver)
	if err != nil {
...
// GetEthermintAddressFromBech32 returns the sdk.Account address of given address,
// while also changing bech32 human readable prefix (HRP) to the value set on
// the global sdk.Config (eg: `ethm`).
// The function fails if the provided bech32 address is invalid.
func GetEthermintAddressFromBech32(address string) (sdk.AccAddress, error) {
